...
0
|| checktplrefresh('./template/september1/common/header.htm', './template/default/common/header_common.htm', 1370946502, '4', './data/template/4_4_common_header_portal_portalcp.tpl.php', './template/september1', 'common/header_portal_portalcp')
|| checktplrefresh('./template/september1/common/header.htm', './template/default/common/header_qmenu.htm', 1370946502, '4', './data/template/4_4_common_header_portal_portalcp.tpl.php', './template/september1', 'common/header_portal_portalcp')
|| checktplrefresh('./template/september1/common/header.htm', './template/september1/common/pubsearchform.htm', 1370946502, '4', './data/template/4_4_common_header_portal_portalcp.tpl.php', './template/september1', 'common/header_portal_portalcp')
;?>
...
<td class="scbar_btn_td"><button type="submit" name="searchsubmit" id="scbar_btn" sc="1" class="pn pnc" value="true"><strong class="xi2 xs2" style="font-size:12px;">搜索</strong></button></td>
