...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1370944549, '1', './data/template/1_1_common_header_portal_view.tpl.php', './template/default', 'common/header_portal_view')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1370944549, '1', './data/template/1_1_common_header_portal_view.tpl.php', './template/default', 'common/header_portal_view')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1370944549, '1', './data/template/1_1_common_header_portal_view.tpl.php', './template/default', 'common/header_portal_view')
;?>
