...
0
|| checktplrefresh('./template/september1/common/header.htm', './template/default/common/header_common.htm', 1370950298, '4', './data/template/4_4_common_header_home_medal.tpl.php', './template/september1', 'common/header_home_medal')
|| checktplrefresh('./template/september1/common/header.htm', './template/default/common/header_qmenu.htm', 1370950298, '4', './data/template/4_4_common_header_home_medal.tpl.php', './template/september1', 'common/header_home_medal')
|| checktplrefresh('./template/september1/common/header.htm', './template/september1/common/pubsearchform.htm', 1370950298, '4', './data/template/4_4_common_header_home_medal.tpl.php', './template/september1', 'common/header_home_medal')
;?>
