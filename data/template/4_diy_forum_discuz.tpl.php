            ...
            <div class="nTab2">
              <div class="TabTitle">
                <ul id="myTab1">
                  ...
                  <li class="normal" onmouseover="nTabs(this,1);">���»ظ�</li>
...
<?php if(!empty($_G['setting']['pluginhooks']['index_forum_extra'][$forum[fid]])) echo $_G['setting']['pluginhooks']['index_forum_extra'][$forum[fid]];?>
                                ...
                                <?php if(empty($forum['redirect'])) { ?><span class="xg1">主题: <?php echo dnumber($forum['threads']); ?></span><span class="xg1">&nbsp;&nbsp;回复: <?php echo dnumber($forum['posts']); ?></span><?php } ?> <span class="xg1">最后更新: 
                                <?php if($forum['permission'] == 1) { ?>
私密版块
<?php } else { if($forum['redirect']) { ?>
<a href="<?php echo $forumurl;?>" class="xi2">链接到外部地址</a>
