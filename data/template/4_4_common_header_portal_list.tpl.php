...
0
|| checktplrefresh('./template/september1/common/header.htm', './template/default/common/header_common.htm', 1370945815, '4', './data/template/4_4_common_header_portal_list.tpl.php', './template/september1', 'common/header_portal_list')
|| checktplrefresh('./template/september1/common/header.htm', './template/default/common/header_qmenu.htm', 1370945815, '4', './data/template/4_4_common_header_portal_list.tpl.php', './template/september1', 'common/header_portal_list')
|| checktplrefresh('./template/september1/common/header.htm', './template/september1/common/pubsearchform.htm', 1370945815, '4', './data/template/4_4_common_header_portal_list.tpl.php', './template/september1', 'common/header_portal_list')
;?>
