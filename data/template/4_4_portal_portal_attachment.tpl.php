...
0
|| checktplrefresh('./template/default/portal/portal_attachment.htm', './template/default/common/header_ajax.htm', 1370946528, '4', './data/template/4_4_portal_portal_attachment.tpl.php', './template/september1', 'portal/portal_attachment')
|| checktplrefresh('./template/default/portal/portal_attachment.htm', './template/default/common/footer_ajax.htm', 1370946528, '4', './data/template/4_4_portal_portal_attachment.tpl.php', './template/september1', 'portal/portal_attachment')
;?>
<?php ob_end_clean();
ob_start();
@header("Expires: -1");
