...
<td>
<span class="ftid2" style="width:60px; height:20px; border:0; overflow:hidden;">
...
<td><input type="text" name="username" id="ls_username" autocomplete="off" class="px vm" tabindex="901" style="width:60px; height:14px; border:0;" /></td>
<?php } else { ?>
...
<td><input type="password" name="password" id="ls_password" class="px vm" autocomplete="off" tabindex="902" style="width:60px; height:14px; border:0;" /></td>
<td><button type="submit" class="pn vm" tabindex="904" style="width: 75px; height:18px; line-height:18px; padding:0; border:0; color:#000;"><em style="color:#000;">登录</em></button></td>
...
<td><a href="javascript:;" onclick="showWindow('login', 'member.php?mod=logging&action=login&viewlostpw=1')">找回密码</a><a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2 xw1"><?php echo $_G['setting']['reglinkname'];?></a></td>
</tr>

</table>
<input type="hidden" name="quickforward" value="yes" />
<input type="hidden" name="handlekey" value="ls" />
            <div style="height:24px; overflow:hidden; float:left; margin:0; padding:0; display:block;"><?php if(!empty($_G['setting']['pluginhooks']['global_login_extra'])) echo $_G['setting']['pluginhooks']['global_login_extra'];?></div>
  </div>
